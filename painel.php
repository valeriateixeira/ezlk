            ...
            function initCreateForm() {
                ...
                function updatePreview() {
                    ...
                    const pvIcons = {
                        ...
                        tk: `<svg viewBox="0 0 24 24" width="${iconSm}" height="${iconSm}" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1v-3.5a6.37 6.37 0 00-.79-.05A6.34 6.34 0 003.15 15.2a6.34 6.34 0 0010.86 4.46v-7.15a8.16 8.16 0 005.58 2.17v-3.44a4.85 4.85 0 01-1-.15z"/></svg>`,
                        ...
                        if (data.success) {
                            formMessage.innerHTML = `
                                <div class="success-box">
                                  <h3>Pronto, sua pagina ta no ar.</h3>
                                  <div class="success-link-row">
                                    <input type="text" value="${location.origin}${data.url}" readonly id="pageLinkInput">
                                    <button type="button" class="copy-btn" id="copyPageBtn">Copiar</button>
                                  </div>
                                  <a href="${data.url}" target="_blank" class="success-visit-btn">Abrir pagina</a>
                                  <p style="margin-top:16px;font-size:0.85rem;color:#666;">Voce pode editar seu perfil a qualquer momento em <a href="/painel" style="font-weight:700;color:#1a1a2e;">Meu Perfil</a>.</p>
                                </div>`;

                            document.getElementById('copyPageBtn').addEventListener('click', function() {
                                const btn = this;
                                navigator.clipboard.writeText(document.getElementById('pageLinkInput').value);
                            ...
                            form.reset();
                            avatarPreview.innerHTML = `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>`;
